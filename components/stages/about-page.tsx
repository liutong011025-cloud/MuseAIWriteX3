...
const translations = {
  en: {
    ...
    advisor1Name: "Prof. Wang Minjuan",
    advisor1Title: "Chair Professor of Emerging Technologies and Future Education",
    advisor2Name: "Dr. Ling Man Ho Alpha",
    advisor2Title: "Acting Head of Department MIT | Associate Professor",
    advisor2Affil: "DMC & DRC Chairperson",
  ...
  yue: {
    ...
    teamTitle: "研究團隊",
    advisor1Name: "王敏娟教授",
    advisor1Title: "新興科技與未來教育講座教授",
    advisor2Name: "凌萬豪博士",
    advisor2Title: "數學與資訊科技學系署理系主任 | 副教授",
    advisor2Affil: "DMC & DRC 主席",
    team1Name: "楊茵博士",
    team1Desc: "首席研究員\n專注AI與教育科技",
    team2Name: "劉通先生",
    team2Desc: "研究團隊成員\n香港教育大學AI與教育科技畢業生",
        ...
        <section className="py-12">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-6 border-4 border-purple-200 shadow-xl hover:shadow-2xl transition-all hover:scale-105 flex gap-6 items-center">
                <div className="relative w-32 h-32 flex-shrink-0 rounded-xl overflow-hidden border-4 border-purple-300">
                  <Image
                    src="https://museaiwrite.eduhk.hk/wp-content/uploads/2025/10/image-6.png"
                    alt={t.advisor1Name}
                    fill
                ...
                <div className="flex-1">
                  <div className="font-bold text-xl text-purple-700 mb-2">{t.advisor1Name}</div>
                  <div className="text-gray-700 font-semibold">{t.advisor1Title}</div>
                </div>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-6 border-4 border-purple-200 shadow-xl hover:shadow-2xl transition-all hover:scale-105 flex gap-6 items-center">
                <div className="relative w-32 h-32 flex-shrink-0 rounded-xl overflow-hidden border-4 border-purple-300">
                  <Image
                    src="https://museaiwrite.eduhk.hk/wp-content/uploads/2025/10/image-5.png"
                    alt={t.advisor2Name}
                    fill
                    className="object-cover"
                    unoptimized
                ...
                <div className="flex-1">
                  <div className="font-bold text-xl text-purple-700 mb-2">{t.advisor2Name}</div>
                  <div className="text-gray-700 font-semibold mb-2">{t.advisor2Title}</div>
                  <div className="text-gray-600">{t.advisor2Affil}</div>
                </div>
              </div>
            </div>
          </div>
